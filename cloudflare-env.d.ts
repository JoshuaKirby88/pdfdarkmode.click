/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: d5d01d10f9ac799edd0fa5261d1d4009)
// Runtime types generated with workerd@1.20250906.0 2024-12-30 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		NEXTJS_ENV: string;
		WORKER_SELF_REFERENCE: Fetcher /* pdf-dark-mode */;
		ASSETS: Fetcher;
	}
}
